...
The proportion of datasets with publications is lower when other taxa are used as model organisms `r ppub[2]` (`r ppub_n_ci$ci[2]`, Poisson exact test)(Fig. \@ref(fig:queryfig), right facet).
