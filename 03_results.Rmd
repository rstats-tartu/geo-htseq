...
(ref:citations) __Citation of articles featuring HT-seq data.__ (`r ref_labels("A", panel_label_case)`) Distribution of the number of citations and availability of full sets of raw P values in GEO database. (`r ref_labels("B", panel_label_case)`) Relationship between the proportion of true nulls and number of citations. Blue line, linear model fit. Citation data is from Scopus.
...
```{r pi0histends, fig.cap='(ref:pi0histends)', fig.height=6}
