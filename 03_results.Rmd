...
(ref:pi0hist) __Proportion of true null hypotheses in P value sets.__

```{r pi0hist, fig.cap='(ref:pi0hist)'}

```

(ref:publications) __Journals publishing HT-seq data.__ (`r ref_labels("A", panel_label_case)`) Non-human or -mouse datasets. (`r ref_labels("B", panel_label_case)`) Human or mouse datasets. (`r ref_labels("C", panel_label_case)`) Human or mouse datasets with p values in supplementary files.
